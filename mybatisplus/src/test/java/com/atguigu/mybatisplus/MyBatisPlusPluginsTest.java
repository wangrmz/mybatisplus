...
public class MyBatisPlusPluginsTest {
    ...
    public void testPage(){
        ...
        System.out.println(page.getRecords());// List。当前查询获取的对象list
        System.out.println(page.getPages());// 总页数
        System.out.println(page.getTotal());//总数
        System.out.println(page.hasNext());//前一页
        System.out.println(page.hasPrevious());//后一页
    }
